        ...
        <?php 
            if( isset( $_POST['submit'] ) ) {
                ...
                if( !empty( $new_updated_image['name'] ) ) {
                    ...
                    $store_image_destination       = $_SERVER['DOCUMENT_ROOT'].'/images/food/'.$rename_new_updated_image_name;
                    
                    /**
                     * First Remove The Existing Image File Prior To Replacing It With New One
                     */
                    $remove = unlink( $_SERVER['DOCUMENT_ROOT'].'/images/food/'.$existing_image_name );
