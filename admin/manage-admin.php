        ...
        <table class="tbl-full" >
            ...
            ?>
                    <tr >
                        ...
                        <td>
                            <a href="<?php echo SITE_URL . 'admin/update-password.php?id=' . $id; ?>" class="" style="margin: 10px;" title="edit password">
                            ...
                            <a href="<?php echo SITE_URL . 'admin/update-admin.php?id=' . $id; ?>" style="margin:10px" class="" title="edit this">
                            ...
                            <a href="<?php echo SITE_URL . 'admin/delete-admin.php?id=' . $id; ?>" style="margin:10px" class="" title="delete this">
